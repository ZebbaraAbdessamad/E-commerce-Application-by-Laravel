...
<div class="container-fluid">
        <form action="{{route('profile.update')}}" method="POST"  enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-9">
                    <div class="row card border-left-primary ml-2">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><i class="fas fa-user"></i> {{__('First name')}}</label>
                                            <input type="text" name="first_name"  value="{{old('first_name',$user->name) ?? '' }}" placeholder="{{__('your name')}}" class="form-control @if($errors->get('first_name')) is-invalid @endif">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" disabled  name="email" value="{{old('email',$user->email) ?? ''}}" placeholder="{{__('your email')}}" class="form-control @if($errors->get('email')) has-invalid @endif">
                                        @if($errors->get('email'))
                                        <div class="text-danger" >
                                            <ul style="list-style-type: none;">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="city" value="{{old('city',$user->city) ?? ''}}" class="form-control @if($errors->get('city')) is-invalid @endif">
                                        @if($errors->get('city'))
                                        <div class="text-danger" >
                                            <ul style="list-style-type: none;">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="country" value="{{old('country',$user->country) ?? ''}}" class="form-control @if($errors->get('country')) is-invalid @endif" required >
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  name="code_post" value="{{old('code_post',$user->code_post) ?? ''}}" class="form-control @if($errors->get('code_post')) is-invalid @endif"required>
                ...
                <div class="col-3">
                    ...
                    <div class="row card m-1 p-3">
                        <div class="form-group">
                            <label class="fw-bold text-black">Gender</label>
                            <div class="flex-b">
